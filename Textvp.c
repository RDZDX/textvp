...
VMINT mre_read_file_display(VMWSTR path) {
    ...
    for (i = 0; i < 20; i++)  // 20 prasisukimu - 20 tekstiniu ekrano eiluciu, kadangi uodega
    {
        ...
        vm_ascii_to_ucs2(value21, (strlen(value10) + 1) * 2, value10);  // 143
        ...
        while (*ptr != '\0') {
            if (trigeris == 0) {
                ...
                vm_ascii_to_ucs2(knv_vns_simbl, (strlen(vns_simbl) + 1) * 2, vns_simbl);    
