...
void handle_keyevt(VMINT event, VMINT keycode) {
    ...
    VMCHAR ccurrFlPosition[101] = {0};
    VMCHAR ctempFlPosition[101] = {0};
    VMCHAR cprviousFlPosit[101] = {0};
    VMCHAR cupFilePosition[101] = {0};

    VMWCHAR ccurrFlPositionX[101] = {0};
    VMWCHAR ctempFlPositionX[101] = {0};
    VMWCHAR cprviousFlPositX[101] = {0};
    VMWCHAR cupFilePositionX[101] = {0};
