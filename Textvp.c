...
VMINT mre_read_file_display(VMWSTR path) {
    ...
    int i, plotis, strng_plot, isve_i_ekr_eil_sk, prasisk_count, prasisk_count1, prasisk_count2, ilgism;
    ...
    //while (i < 20 || isve_i_ekr_eil_sk == 20) {
        ...
        while (*ptr != '\0') {
            ...
            //if (ilgism > 14 || *ptr == '\n' || prasisk_count2 > 14) { //kaupiame 15 simboliu fragmenta pries konvertuojant i USC2. Jei isve_i_ekr_eil_sk > 20 !!!
